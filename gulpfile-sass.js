...
gulp.task('js:main', function () {
  var files = [ 'source/js/components/_*.js', 'source/js/controllers/_*.js']
...
gulp.task('iconfont', function() {
  gulp.src(['source/img/svg/*.svg'])
    .pipe(iconfontCSS({
      fontName: 'icon',
      targetPath: '../scss/inc/_icons.scss',
      fontPath: '/arquivos/'
    }))
    .pipe(iconfont({
      fontName: 'icon',
...
gulp.task('sprite', function() {
  ...
  .pipe($.spritesmith({
	...
	spriteData.css
		.pipe(gulp.dest('source/scss/inc/'))
		.pipe(browserSync.reload({ stream: true }));
});
...
gulp.task('watch', function () {
  ...
  gulp.watch(['source/scss/**/*.scss', 'source/img/sprite/*.png'], ['sass']);
...
gulp.task('build', ['js', 'iconfont','copy-fonts', 'copy-fonts', 'sass', 'css', 'img', 'pug']);
